...
echo EnviaImgPdfScielo.bat \scieloproceedings transf\EnviaImgPdfLogOn.txt log\EnviaImgPdfScieloPadrao.log cria \scieloproceedings\web\htdocs
echo.
echo Tecle CONTROL-C para sair ou ENTER para continuar...

pause > nul

EnviaImgPdfScielo.bat \scieloproceedings transf\EnviaImgPdfLogOn.txt log\EnviaImgPdfScieloPadrao.log cria \scieloproceedings\web\htdocs
