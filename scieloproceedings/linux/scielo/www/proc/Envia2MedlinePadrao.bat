...
echo
echo Envia2Medline.bat .. transf/Envia2MedlinePadrao.txt log/envia2medline.log cria
echo
echo Tecle CONTROL-C para sair ou ENTER para continuar...

call Envia2Medline.bat .. transf/Envia2MedlinePadrao.txt log/envia2medline.log cria
