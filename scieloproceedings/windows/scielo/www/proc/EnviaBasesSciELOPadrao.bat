...
echo EnviaBasesScielo.bat \scieloproceedings transf\EnviaBasesLogOn.txt log\EnviaBasesScieloPadrao.log cria
echo.
echo Tecle CONTROL-C para sair ou ENTER para continuar...

pause > nul

EnviaBasesScielo.bat \scieloproceedings transf\EnviaBasesLogOn.txt log\EnviaBasesScieloPadrao.log cria
